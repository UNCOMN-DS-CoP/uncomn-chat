const translation = {
  translation: {
    ...
    app: {
      ...
      legalMessage: 'The information provided by JARVIS is generated by artificial intelligence (“AI”) and should not be considered a substitute for, including but not limited to, any of the following:  1) professional advice; 2) official company policies; or 3) published documents.  AI generated material, content, information, etc. should only be used for informational purposes and should not be utilized as a substitute for decision making. <br><br>The user assumes full responsibility for the use and application of any JARVIS content.  UNCOMN, its Partners, its Employees, and all other Affiliates cannot be held liable for damages, losses, or consequences arising from the use or misuse of JARVIS generated content; UNCOMN disclaims all liability related to the application of or reliance on JARVIS content.',
